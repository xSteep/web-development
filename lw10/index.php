  ...
  <div id="back" class="outside">
    <div class="form__border">
        <article id="popup" class="form">
            ...
            <form class="form__user-form" method="post" action="register.php">
                <input required class="form__text-place" type="text" placeholder="Ваше имя" name="name">
                <input required class="form__text-place" type="email" placeholder="Email" name="email">
                <select required class="form__list" name="activity">
                    <option style="display: none" class="form__option_special" disabled selected>Деятельность</option>
                ...
                <div class="form__user-deal">
                    <input class="form__checkbox" id="subscribeNews" type="checkbox" name="subscribe" value="newsletter">
